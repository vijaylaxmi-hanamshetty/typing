...
import { resetTest, startTest, submitTest, updateTimeLeft, updateTypedChars } from "../../../redux/feature/TypeingTestSlice";
import TypeDisplay from'./TypeDisplay'
import Timer from "./Timer";
import SpeedStats from "./SpeedStats";
import { Button } from "flowbite-react";
import TypingArea from "./TypeingArea";
...
const TypingApp = () => {
  ...
  return (
    <div className="mt-8 space-y-4 px-4">
      ...
      <TypeDisplay text={text} currentIndex={currentIndex} />
